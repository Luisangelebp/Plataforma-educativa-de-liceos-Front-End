...
import { CalificacionesRepresentante } from './components/Dashboards/Representante/BoletinesRepresentante.jsx';
...
import { CalificacionesSecundaria } from './components/Dashboards/Profesor/CalificacionesSecundaria.jsx';
                ...
                <Routes>
                    ...
                    <Route element={<PrivateGuard RouteRol="admin" />}>
                        <Route path="/admin" element={<Admin />}>
                            ...
                            <Route path="listaA" element={<ListaA />} />
                    ...
                    <Route element={<PrivateGuard RouteRol="representante" />}>
                        ...
                        >
                            ...
                            <Route
                                path="boletines"
                                element={<CalificacionesRepresentante />}
                            />
                            <Route
                                path="cuenta"
                    ...
                    <Route element={<PrivateGuard RouteRol="profesor" />}>
                        <Route path="/profesor" element={<Profesor />}>
                            ...
                            />
                            <Route
                                path="calificaciones/secundaria"
                                element={<CalificacionesSecundaria />}
                            />
