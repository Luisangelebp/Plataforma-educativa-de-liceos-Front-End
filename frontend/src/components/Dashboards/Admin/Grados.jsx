                    ...
                    {primaria.length > 0 && (
                        <div className="section-card" style={{marginBottom: '25px'}}>
                            <div className="section-header" style={{
                                ...
                                <h2 className="section-title" style={{fontSize: '1.3rem', fontWeight: '600', margin: 0}}>Primaria</h2>
                                <div style={{display: 'flex', gap: '8px'}}>
                                    <button
                                        ...
                                        style={{
                                            ...
                                            height: '40px',
                                            padding: '0',
                                            background: viewMode === 'cards' ? 'var(--primary)' : 'white',
                                            color: viewMode === 'cards' ? 'white' : 'var(--gray)',
                                            border: `2px solid ${viewMode === 'cards' ? 'var(--primary)' : 'var(--light-gray)'}`,
                                    ...
                                    <button
                                        ...
                                        style={{
                                            ...
                                            color: viewMode === 'table' ? 'white' : 'var(--gray)',
                                            border: `2px solid ${viewMode === 'table' ? 'var(--primary)' : 'var(--light-gray)'}`,
                                            borderRadius: 'var(--border-radius-sm)',
                                            cursor: 'pointer',
                                            display: 'flex',
                                            alignItems: 'center',
                        ...
                        {primaria.map((grado) => (
                                    ...
                                    >
                                        <div style={{
                                            ...
                                            <div>
                                                ...
                                                <p style={{
                                                    ...
                                                    Sección: <strong>{grado.seccion}</strong>
                                                </p>
                                            </div>
                                            <div style={{
                                                width: '45px',
                                        ...
                                        <div style={{
                                            ...
                                            <button
                                                className="btn"
                                                onClick={() => setShowHorario(grado.id)}
                                                style={{
                                                    flex: 1,
                                                    padding: '10px 12px',
                                                    fontSize: '0.85rem',
                                ...
                                <div className="table-responsive">
                                    <table className="data-table">
                                        <thead>
                                            <tr>
                                                <th style={{fontSize: '0.95rem', fontWeight: '700', padding: '16px 18px'}}>Grado</th>
                                                <th style={{fontSize: '0.95rem', fontWeight: '700', padding: '16px 18px'}}>Sección</th>
                                                <th style={{fontSize: '0.95rem', fontWeight: '700', padding: '16px 18px'}}>Nivel</th>
                                                <th style={{fontSize: '0.95rem', fontWeight: '700', padding: '16px 18px'}}>Acciones</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            {primaria.map((grado) => (
                    ...
                    {secundaria.length > 0 && (
                        <div className="section-card">
                            <div className="section-header" style={{
                                ...
                                <h2 className="section-title" style={{fontSize: '1.3rem', fontWeight: '600', margin: 0}}>Secundaria</h2>
                                <div style={{display: 'flex', gap: '8px'}}>
                                    <button
                                        className={`view-btn ${viewMode === 'cards' ? 'active' : ''}`}
                                        onClick={() => setViewMode('cards')}
                        ...
                        {secundaria.map((grado) => (
                                ...
                                <div className="table-responsive">
                                    <table className="data-table">
                                        <thead>
                                            <tr>
                                                <th style={{fontSize: '0.95rem', fontWeight: '700', padding: '16px 18px'}}>Año</th>
                                                <th style={{fontSize: '0.95rem', fontWeight: '700', padding: '16px 18px'}}>Sección</th>
                                                <th style={{fontSize: '0.95rem', fontWeight: '700', padding: '16px 18px'}}>Nivel</th>
                                                <th style={{fontSize: '0.95rem', fontWeight: '700', padding: '16px 18px'}}>Acciones</th>
                                            </tr>
        ...
        <div className="modal" onClick={onClose}>
            <div className="modal-content" onClick={(e) => e.stopPropagation()}>
                <div className="modal-header">
                    <h3 className="modal-title">Registrar Nuevo Grado-Sección</h3>
                    <button className="close-modal" onClick={onClose}>&times;</button>
                </div>
                <div className="modal-body">
                    <form onSubmit={handleSubmit}>
                        <div className="form-group">
                            <label htmlFor="nivel" style={{fontSize: '0.95rem'}}>
                                Nivel Escolar *
                            </label>
                            <div className="input-with-icon">
                                <i className="fas fa-layer-group" style={{fontSize: '0.8rem'}}></i>
                            <select
                                id="nivel"
                                name="nivel"
                        ...
                        <div className="form-grid">
                            <div className="form-group">
                                <label htmlFor="grado" style={{fontSize: '0.95rem'}}>
                            ...
                            <div className="form-group">
                                <label htmlFor="seccion" style={{fontSize: '0.95rem'}}>
                                    Sección *
                                </label>
                                <div className="input-with-icon">
...
const VerHorario = ({ isOpen, onClose, grado }) => {
    ...
    function Calendario() {
        const getProfesorNombre = (profesorId) => {
            ...
            return `${profesor.nombre || ''} ${profesor.apellido || ''}`.trim() || 'N/A';
        };
                        ...
                        {dias.map((dia) => {
                            ...
                            return (
                                <div key={dia + hora} style={{
                                    ...
                                    position: 'relative',
                                    padding: clase ? '8px' : '0',
                                    background: clase ? 'rgba(67, 97, 238, 0.05)' : 'transparent'
                                }}>
                                    {clase ? (
                                        <div style={{
                                            ...
                                            <div>
                                                <strong style={{fontSize: '0.8rem', display: 'block', marginBottom: '4px'}}>
                                                    {materias.find((m) => m.id === clase.materia)?.nombre || 'N/A'}
                                                </strong>
                                                <span style={{fontSize: '0.7rem', opacity: 0.9}}>
                                                    {clase.hora_inicio.slice(0, 5)} - {clase.hora_fin.slice(0, 5)}
                                                </span>
                                            </div>
                                            <div style={{marginTop: '6px', fontSize: '0.7rem', opacity: 0.9}}>
                                                {getProfesorNombre(clase.profesor)}
                                            </div>
                                            <button
                                                onClick={() => {
                                                    if (confirm(`¿Eliminar el horario de ${materias.find((m) => m.id === clase.materia)?.nombre || 'esta clase'}?`)) {
                                                        axios.delete(`${API_URL}/horarios/${clase.id}/`)
                                                            .then(() => {
                                                                alert('Horario eliminado correctamente.');
                                                                setHorario(horario.filter((m) => m.id !== clase.id));
                                                            })
                                                            .catch((error) => {
    ...
    return (
        <div className="modal" onClick={onClose}>
            <div className="modal-content" onClick={(e) => e.stopPropagation()} style={{maxWidth: '95vw', maxHeight: '90vh'}}>
                <div className="modal-header">
                ...
                <div className="modal-body" style={{padding: '20px'}}>
                    ...
                    {!loading && horario && horario.length === 0 && (
                        <div style={{
                            ...
                            <i className="fas fa-calendar-times" style={{fontSize: '1.5rem', marginBottom: '12px', color: 'var(--light-gray)', opacity: 0.6}}></i>
                            <p style={{fontSize: '0.95rem'}}>No hay horarios registrados para este grado.</p>
                        </div>
                    )}
                    {!loading && horario && horario.length > 0 && (
