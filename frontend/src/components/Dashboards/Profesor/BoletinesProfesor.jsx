        ...
        <div className="main-content">
            <div className="header">
                <div className="page-title" style={{width: '100%', textAlign: 'center'}}>
                    <h1 style={{color: 'var(--dark)', margin: 0}}>Gestión de Boletines</h1>
                    <p style={{color: 'var(--gray)', margin: '8px 0 0 0'}}>Sube y gestiona los boletines de tus estudiantes</p>
                </div>
            </div>

            {/* Sección de Plantillas */}
            <div className="section-card" style={{marginBottom: '30px', maxWidth: '1200px', margin: '0 auto 30px auto'}}>
                <div style={{
                    display: 'flex',
                    ...
                    <h2 style={{
                        ...
                        <i className="fas fa-file-word" style={{color: '#2b579a', fontSize: '1.2rem'}}></i>
                ...
                {plantillas.length > 0 ? (
                    <div style={{
                        ...
                        {plantillas.map((plantilla) => (
                            ...
                            >
                                <i className="fas fa-file-word" style={{
                                    fontSize: '2.5rem',
                                    color: '#2b579a'
                                }}></i>
                                <p style={{
            ...
            <div className="section-card" style={{maxWidth: '1200px', margin: '0 auto'}}>
                <h2 style={{
                    ...
                    <i className="fas fa-file-pdf" style={{color: 'var(--danger)', fontSize: '1.2rem'}}></i>
                    Subir Boletines PDF
                </h2>
                <div className="table-container">
                    <table className="boletines-table" style={{
                        width: '100%',
                                            ...
                                            {boletin ? (
                                                <button
                                                    ...
                                                    style={{
                                                        ...
                                                        gap: '8px',
                                                        transition: 'var(--transition)',
                                                        boxShadow: '0 4px 15px rgba(248, 150, 30, 0.3)',
                                                        minWidth: '120px'
                                                    }}
                                                    onMouseEnter={(e) => {
                                                        e.currentTarget.style.background = '#e0a800';
                                                        e.currentTarget.style.transform = 'translateY(-2px)';
                                                        e.currentTarget.style.boxShadow = '0 6px 20px rgba(248, 150, 30, 0.4)';
                                                    }}
                                                    onMouseLeave={(e) => {
                                                        e.currentTarget.style.background = 'var(--warning)';
                                                        e.currentTarget.style.transform = 'translateY(0)';
                                                        e.currentTarget.style.boxShadow = '0 4px 15px rgba(248, 150, 30, 0.3)';
                                                    }}
                                                >
            ...
            {showUploadModal && selectedEstudiante && (
                <div className="modal" onClick={() => setShowUploadModal(false)} style={{
                    position: 'fixed',
                    top: 0,
                    left: 0,
                    right: 0,
                    ...
                    <div className="modal-content" onClick={(e) => e.stopPropagation()} style={{
                        ...
                        <div className="modal-header" style={{
                            ...
                            <h3 className="modal-title" style={{
                                ...
                                <i className={`fas ${selectedEstudiante.boletinExistente ? 'fa-edit' : 'fa-upload'}`} style={{
                                    color: selectedEstudiante.boletinExistente ? 'var(--warning)' : 'var(--primary)',
                                    fontSize: '1.2rem'
                                }}></i>
                                {selectedEstudiante.boletinExistente ? 'Actualizar Boletín' : 'Subir Boletín PDF'}
                            </h3>
                            <button className="close-modal" onClick={() => setShowUploadModal(false)} style={{
                                background: 'none',
                                border: 'none',
                                fontSize: '1.5rem',
                                color: 'var(--gray)',
                        ...
                        <div className="modal-body">
                            <div style={{marginBottom: '20px'}}>
                                <p style={{
                                    ...
                                    <i className="fas fa-user" style={{color: 'var(--primary)', fontSize: '0.85rem'}}></i>
                                ...
                                <p style={{
                                    ...
                                    <i className="fas fa-calendar-alt" style={{color: 'var(--primary)', fontSize: '0.85rem'}}></i>
                            ...
                            <div style={{
                                ...
                                <p style={{
                                    ...
                                    <span>
                                        <strong>Nota:</strong> Descarga la plantilla Word, complétala, convierte a PDF y súbelo aquí.
                                    </span>
                                </p>
                            </div>
                        <div className="form-group">
                                <label htmlFor="archivo_pdf" style={{
                                    fontSize: '0.95rem',
                                    fontWeight: '500',
                                    color: 'var(--dark)',
                                    marginBottom: '10px',
                            ...
                            />
                                ...
                                {uploadData.archivo_pdf && (
                                    <small style={{
                                        ...
                                        Archivo seleccionado: {uploadData.archivo_pdf.name}
                                    </small>
                                )}
                            </div>
                            <div style={{
                            ...
                            >
                                ...
                                <button
                                    ...
                                    style={{
                                        padding: '12px 30px',
                                        background: selectedEstudiante.boletinExistente ? 'var(--warning)' : 'var(--primary)',
                                        color: 'white',
                                        border: 'none',
                                        borderRadius: 'var(--border-radius)',
                                        fontSize: '0.9rem',
                                        ...
                                        gap: '8px',
                                        transition: 'var(--transition)',
                                        boxShadow: selectedEstudiante.boletinExistente 
                                            ? '0 4px 15px rgba(248, 150, 30, 0.3)'
                                            : '0 4px 15px rgba(67, 97, 238, 0.3)'
                                    }}
                                    onMouseEnter={(e) => {
                                        e.currentTarget.style.background = selectedEstudiante.boletinExistente ? '#e0a800' : 'var(--primary-dark)';
                                        e.currentTarget.style.transform = 'translateY(-2px)';
                                    }}
                                    onMouseLeave={(e) => {
                                        e.currentTarget.style.background = selectedEstudiante.boletinExistente ? 'var(--warning)' : 'var(--primary)';
                                        e.currentTarget.style.transform = 'translateY(0)';
                                    }}
                                >
                                    <i className={`fas ${selectedEstudiante.boletinExistente ? 'fa-edit' : 'fa-upload'}`} style={{
                                    ...
                                    {selectedEstudiante.boletinExistente ? 'Actualizar' : 'Subir'}
                            </button>
                            </div>
                        </div>
                    </div>
